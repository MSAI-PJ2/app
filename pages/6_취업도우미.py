"""[취업 준비] 공고 적합도 분석 · 자소서 초안 · 첨삭 — 마음숲의 취준생 확장 페이지.
...
st.set_page_config(page_title="취업 준비 · 마음숲", page_icon="🌱", layout="wide")
apply_theme()
...
<div class="career-hero">
  ...
  <div class="small-note" style="margin-top:.3rem;">
    ...
    여기서 나온 근거 문장은 <b>대화하기</b>에서 여울이가 함께 봐요.
  </div>
</div>
""", unsafe_allow_html=True)
...
if a and "fit_score" in a:
    ...
    if a.get("reframe_evidence"):
        st.markdown("**여울이가 기억할 사실 근거** — \"다 안 될 거야\"라는 생각이 들 때 함께 봐요")
